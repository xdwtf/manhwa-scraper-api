...
async function info(slug) {
    ...
    try{
        res = await axios.get(`https://manhwahentai.me/webtoon/${slug}`)
        ...
        let ch_list = await chaptersList(`https://manhwahentai.me/webtoon/${slug}/ajax/chapters/`)
...
async function all(page) {
    ...
    try{
        res = await axios.get(`https://manhwahentai.me/webtoon/page/${page}`)
        const body = await res.data;
        const $ = cheerio.load(body)
...
async function chapter(manga,chapter) {
    ...
    try{
        res = await axios.get(`https://manhwahentai.me/webtoon/${manga}/${chapter}`)
        const body = await res.data;
        const $ = cheerio.load(body)
